...
func (uu *UserUpdate) AddUserPredicamentIDs(ids ...int) *UserUpdate {
	uu.mutation.AddUserPredicamentIDs(ids...)
	return uu
}

// AddUserPredicament adds the user_predicament edges to Predicament.
func (uu *UserUpdate) AddUserPredicament(p ...*Predicament) *UserUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uu.AddUserPredicamentIDs(ids...)
}
...
func (uu *UserUpdate) RemoveUserPredicamentIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveUserPredicamentIDs(ids...)
	return uu
}

// RemoveUserPredicament removes user_predicament edges to Predicament.
func (uu *UserUpdate) RemoveUserPredicament(p ...*Predicament) *UserUpdate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uu.RemoveUserPredicamentIDs(ids...)
}
...
func (uu *UserUpdate) Save(ctx context.Context) (int, error) {
	...
	if v, ok := uu.mutation.UserPassword(); ok {
		if err := user.UserPasswordValidator(v); err != nil {
			return 0, &ValidationError{Name: "user_password", err: fmt.Errorf("ent: validator failed for field \"user_password\": %w", err)}
		}
	}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := uu.mutation.RemovedUserPredicamentIDs(); len(nodes) > 0 {
	...
	if nodes := uu.mutation.UserPredicamentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.UserPredicamentTable,
...
// AddUserPredicamentIDs adds the user_predicament edge to Predicament by ids.
func (uuo *UserUpdateOne) AddUserPredicamentIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.AddUserPredicamentIDs(ids...)
	return uuo
}

// AddUserPredicament adds the user_predicament edges to Predicament.
func (uuo *UserUpdateOne) AddUserPredicament(p ...*Predicament) *UserUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uuo.AddUserPredicamentIDs(ids...)
}
...
// RemoveUserPredicamentIDs removes the user_predicament edge to Predicament by ids.
func (uuo *UserUpdateOne) RemoveUserPredicamentIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.RemoveUserPredicamentIDs(ids...)
	return uuo
}

// RemoveUserPredicament removes user_predicament edges to Predicament.
func (uuo *UserUpdateOne) RemoveUserPredicament(p ...*Predicament) *UserUpdateOne {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uuo.RemoveUserPredicamentIDs(ids...)
}
...
func (uuo *UserUpdateOne) Save(ctx context.Context) (*User, error) {
	...
	if v, ok := uuo.mutation.UserPassword(); ok {
		if err := user.UserPasswordValidator(v); err != nil {
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (u *User, err error) {
	...
	if nodes := uuo.mutation.RemovedUserPredicamentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.UserPredicamentTable,
	...
	if nodes := uuo.mutation.UserPredicamentIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.UserPredicamentTable,
