...
// The PredicamentFunc type is an adapter to allow the use of ordinary
// function as Predicament mutator.
type PredicamentFunc func(context.Context, *ent.PredicamentMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PredicamentFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PredicamentMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PredicamentMutation", m)
	}
	return f(ctx, mv)
}
...
// The StatuscarFunc type is an adapter to allow the use of ordinary
// function as Statuscar mutator.
type StatuscarFunc func(context.Context, *ent.StatuscarMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f StatuscarFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.StatuscarMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.StatuscarMutation", m)
	}
	return f(ctx, mv)
}
